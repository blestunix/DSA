/*
 * Approach: Find the minimum element in the array starting from the current index and replace it with the value at current index.
 ...
 *
 * Stats:
 *                     Worst case running time: O(𝑛²)
 *      Average-case(or expected) running time: O(𝑛²)
 */
